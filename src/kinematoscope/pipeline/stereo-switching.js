...
export class PipelineStereoSwitching {
  /**
  ...
  static async create(media, model, inference) {
    console.debug(PipelineStereoSwitching.name, PipelineStereoSwitching.create.name);
    ...
    streamNodes.push(
      await NodeStereoFrameSwitch.create({
